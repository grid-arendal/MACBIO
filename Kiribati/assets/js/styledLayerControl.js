L.Control.StyledLayerControl = L.Control.Layers.extend({
    ...
    _addItem: function(obj) {
        ...
        name.innerHTML = ' ' + obj.name;
          ...
          //required layer list
 var layList = "krbeez,density,coldwater,basins,salinity,populated_places,seamount,canyons,abyssal,escarpments,guyots,seamounts,rift_valleys,troughs,ridges,spreading_ridges,trenches,plateaus,shelf,slope,volcanoes,earthquakes,hydrothermal,currents,reefs_1,pelagic,benthic,ebsaregions_20150521,kba_1,deepwater_2,reefbio_1,tunacatch,aquaculture,anchorages_1,passengervessel,airport,wharves,cruiseships,cables_360,ports,imo_2,cyclones,kiribati_deep_fisheries_360,sst,chl,parf,oceandepth,phosphate,nitrate,calcite,ph,kirvessel";
